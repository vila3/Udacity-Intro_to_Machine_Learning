...
importance_features = [(index, importance) for index, importance in enumerate(classifier.feature_importances_) if importance > 0.2]

for feature in importance_features:
    print vectorizer.get_feature_names()[feature[0]], '-', feature[1]
